...
\begin{figure}[t]
\centering
\caption{Relationship between Local Consumption and Correlation ($\rho$), Risk Aversion ($\gamma$)}
\begin{subfigure}{.3\linewidth}
...
\begin{figure}[t]
\caption{Relationship between User Welfare, Diversity and Correlation ($\rho$), Risk Aversion ($\gamma$)}\label{fig:diversity_welfare_correlation}
