...
\copyrightyear{2020}
\acmYear{2020}
\setcopyright{acmlicensed}\acmConference[RecSys '20]{Fourteenth ACM Conference on Recommender Systems}{September 21--26, 2020}{Virtual Event, Brazil}
...
\afterpage{
\begin{figure}[t]
\caption{Local Consumption and Correlation}
...
\begin{figure}[t]
\centering
\caption{Relationship between Local Consumption and Correlation ($\rho$) and Risk Aversion ($\gamma$)}
\begin{subfigure}{.3\linewidth}
...
\begin{figure}[t]
\caption{Relationship between Correlation ($\rho$) and Risk Aversion ($\gamma$), and User Welfare and Diversity}\label{fig:diversity_welfare_correlation}
\begin{subfigure}{0.3\linewidth}
  \includegraphics[width=1.0\linewidth]{figures/rho_diversity_N_200_T_20.pdf}
\end{subfigure}
\begin{subfigure}{0.3\linewidth}
\includegraphics[width=1.0\linewidth]{figures/gamma_diversity_N_200_T_20.pdf}
\end{subfigure}
\begin{subfigure}{0.3\linewidth}
