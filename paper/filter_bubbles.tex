...
\end{array} \right)
\]
Suppose that, in period 1, the user breaks ties arbitrarily breaking the tie arbitrarily, consumes product 0. The underlying correlation structure implies that upon observing that $x_1=y$ the user will update beliefs about the remaining 3 products according to the previously specified updating rule. For concreteness, we suppose that $\sigma = 1$, $y = 0.5$, and $\rho = 0.5$. The resulting beliefs after observing $y$ are then as follows:
...
\frac{3}{4} & \frac{3}{8} & 0.0 \vspace{0.15cm} \\
\frac{3}{8} & \frac{15}{16} & \frac{3}{8} \vspace{0.15cm}  \\
0.0 &\frac{3}{8} & \frac{3}{4}  \\
\end{array} \right)
\]
