...
\par
In line with Nguyen, et. al (2014), recommendation alleviates these filter bubble effects. However, we find that it also leads to an increase in homogeneity across users, resulting in a trade-off between homogenizing across user consumption and diversifying
