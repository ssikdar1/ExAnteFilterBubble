...
\end{subfigure}
\caption{Extent of Local Consumption for No Recommendation (Top Left), Recommendation (Top Right) and Oracle (Bottom) for different Correlation values}
...
\end{subfigure}
\captionof{figure}{User Welfare and Diversity as the strength of correlation, $\rho$, varies}\label{fig:diversity_correlation}
\end{figure}
...
\end{subfigure}
\captionof{figure}{User Welfare and Diversity as the strength of the common value component, $\beta$, varies}\label{fig:diversity_correlation}
\end{figure}
...
\end{subfigure}\\
\captionof{figure}{Diversity vs. Welfare, No-Recommendation, $\gamma = 0$ (Left), Diversity vs. Welfare, $\gamma = 5$ (Right)}\label{fig:diversity_welfare_ra}
\end{figure}
...
\end{subfigure}\\
\captionof{figure}{Diversity vs. Welfare, Recommendation, $\gamma = 0$ (Left), Diversity vs. Welfare, $\gamma = 5$ (Right)}\label{fig:diversity_welfare_ra_partial}
\end{figure}
